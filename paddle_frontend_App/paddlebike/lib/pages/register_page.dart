...
import 'package:paddlebike/constants/buttonimage.dart';
import 'package:paddlebike/constants/tesxtfileds.dart';
import 'package:paddlebike/pages/login_page.dart';
import 'package:paddlebike/pages/register2_page.dart';
    ...
    try {
      ...
      if (response.success && response.data != null) {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) =>
                Register2Page(registrationToken: response.data!.token),
          ),
        );
      } else {
