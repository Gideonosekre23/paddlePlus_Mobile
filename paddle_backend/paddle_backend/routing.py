...
from chat.consumers import ChatConsumer, UserNotificationConsumer, ArduinoConsumer
...
websocket_urlpatterns = [
    ...
    re_path(r'^ws/notifications/(?P<channel_id>[\w._-]+)/$', UserNotificationConsumer.as_asgi()),
    re_path(r'^ws/arduino/(?P<hardware_id>[\w-]+)/$', ArduinoConsumer.as_asgi()),
]
